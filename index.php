              ...
              <li>
                <h1 class="logo-wrapper">
                  <a href="index.php" class="brand-logo darken-1">
                    <img src="icon/materialize-logo.png" alt="materialize logo">
      ...
      <div class="footer-copyright">
        <div class="container">
          <span>Copyright ©
            ...
            </script> <a class="grey-text text-lighten-4" href="https://t.me/LamasFoker" target="_blank">LamaFoker</a> All rights reserved.</span>
